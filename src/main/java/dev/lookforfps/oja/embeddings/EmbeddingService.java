package dev.lookforfps.oja.embeddings;

import com.fasterxml.jackson.core.JsonProcessingException;
import lombok.Getter;
import lombok.Setter;
import lombok.extern.slf4j.Slf4j;
import dev.lookforfps.oja.aimodel.EmbeddingModel;
import dev.lookforfps.oja.aimodel.ModerationModel;
import dev.lookforfps.oja.embeddings.mapping.MappingService;
import dev.lookforfps.oja.embeddings.config.EmbeddingConfiguration;
import dev.lookforfps.oja.embeddings.model.input.NestedIntegerArrayInput;
import dev.lookforfps.oja.embeddings.model.input.IntegerArrayInput;
import dev.lookforfps.oja.embeddings.model.input.StringArrayInput;
import dev.lookforfps.oja.embeddings.model.input.StringInput;
import dev.lookforfps.oja.embeddings.model.request.EmbeddingRequestDto;
import dev.lookforfps.oja.embeddings.model.response.EmbeddingResponse;
