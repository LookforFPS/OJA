...
public enum ChatCompletionModel {
     ...
     */
    GPT_4_O(new AIModel("gpt-4o", "GPT-4o")),
    /**
     * <b>Description: </b>
     ...
     */
    GPT_4_TURBO(new AIModel("gpt-4-turbo", "GPT-4-Turbo")),
    /**
     * <b>Description: </b>
     * Currently points to gpt-4-0613.
     */
    GPT_4(new AIModel("gpt-4", "GPT-4")),

    /**
     * <b>Description: </b>
     * Currently points to gpt-3.5-turbo-0125.
     */
    GPT_3_5_TURBO(new AIModel("gpt-3.5-turbo", "GPT-3.5-Turbo"));
